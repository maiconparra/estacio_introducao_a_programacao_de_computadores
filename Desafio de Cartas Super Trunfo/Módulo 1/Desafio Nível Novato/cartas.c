...
int main() {
    ...
    printf("Estado: %c \nCódigo: %c%2s \nNome da Cidade: %s \nPopulação: %d \nAera (m^2): %f \nPIB: %f \nPontos Turísticos: %d", card1_estado, card1_estado, card1_codigo, card1_nome_cidade, card1_populacao, card1_area, card1_pib, card1_pontos_turisticos);

    printf("\n\n");

    printf("Estado: %c \nCódigo: %c%s \nNome da Cidade: %s \nPopulação: %d \nAera (m^2): %f \nPIB: %f \nPontos Turísticos: %d", card2_estado, card2_estado, card2_codigo, card2_nome_cidade, card2_populacao, card2_area, card2_pib, card2_pontos_turisticos);
